...
function [centers,radii] = findbeadsbyposition(img,mask_function,varargin)
...
table_obj(indexes,:) = [];
indexes = table_obj.Area > 6000;
table_obj(indexes,:) = [];
indexes = table_obj.Circularity < 0.5; % circularity
table_obj(indexes,:) = [];
